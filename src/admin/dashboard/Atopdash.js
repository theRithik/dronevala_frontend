...
import ALeftdash from "./AleftDash";


const AtopDashheader=()=>{
...
const menurender=(data)=>{
  ...
  <i class={`bi bi-${item.icon}`}>
    ...
    return(
      ...
      <hr/>
      <Link to="/admin/settings" style={{color:'inherit'}}>
      <li>
  ...
  <p>Settings</p>
    ...
    return(
      <>
      <Link to="/admin/allvendors" style={{color:'inherit'}}>
  <li >
  ...
  <Link to="/admin/allusers" style={{color:'inherit'}}>
  <li>
