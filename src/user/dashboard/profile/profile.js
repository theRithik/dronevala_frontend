...
<div style={{marginTop:'10%'}}>
    ...
    <input type="text"  onChange={inputchange} name="fname" className="form-control profileinput" value={details.lname} placeholder="Last Name" id="lname"/>
    <i class="bi bi-person Instprofileinputicon"></i>
        </div>
        </div>
        </div>
    ...
    <input type="number"  onChange={inputchange} name="altph" className="form-control profileinput" value={details.altph} placeholder="Alternative phone" id="altph"/>
